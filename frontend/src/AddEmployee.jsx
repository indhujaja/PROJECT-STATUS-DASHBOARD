		...
		<div className='d-flex flex-column align-items-center pt-4'>
			...
			<div className="col-12">
				...
				<div className="col-12">
					...
					<input type="text" className="form-control" id="inputEmail4" placeholder='Enter Email' autoComplete='off'
				...
				<div className="col-12">
					<label htmlFor="inputAddress" className="form-label">Department</label>
					<input type="text" className="form-control" id="inputAddress" placeholder="Enter Department" autoComplete='off'
